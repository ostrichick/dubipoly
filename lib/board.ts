...
const korea: CityDefinition[] = [
  [
    ...
    'Gwangju',
    '🎨',
    { ko: '한국 서남부', es: 'Suroeste de Corea', en: 'Southwestern Korea' },
  ],
  [
    '전주',
    'Jeonju',
  ...
  [
    ...
    {
      ko: '한국 중부·내륙',
      es: 'Centro e interior de Corea',
      en: 'Central & Inland Korea',
    },
  ],
  [
    '수원',
  ...
  [
    ...
    {
      ko: '한국 동남부·동해',
      es: 'Sureste y costa este de Corea',
      en: 'Southeastern & East Coast Korea',
    },
  ],
  [
    '속초',
  ...
  [
    ...
    'Jeju',
    '🍊',
    { ko: '한국 섬', es: 'Isla coreana', en: 'Korean Island' },
  ],
  [
    '인천',
    'Incheon',
...
const peru: CityDefinition[] = [
  [
    ...
    'Puno',
    '⛵',
    { ko: '페루 남동부', es: 'Sureste del Perú', en: 'Southeastern Peru' },
  ],
  [
    '아레키파',
    'Arequipa',
  ...
  [
    ...
    {
      ko: '페루 남부 사막',
      es: 'Desierto del sur del Perú',
      en: 'Southern Peru Desert',
    },
  ],
  [
    '아야쿠초',
    ...
    'Ayacucho',
    '🎨',
    { ko: '페루 중부', es: 'Centro del Perú', en: 'Central Peru' },
  ],
  [
    '와라스',
    'Huaraz',
  ...
  [
    ...
    {
      ko: '페루 북부·아마존',
      es: 'Norte y Amazonía del Perú',
      en: 'Northern Peru & Amazon',
    },
  ],
  [
    '치클라요',
  ...
  [
    ...
    {
      ko: '페루 수도권',
      es: 'Área metropolitana de Lima',
      en: 'Lima Capital Area',
    },
  ],
];
...
export const board: Space[] = Array.from({ length: 40 }, (_, index) => {
  ...
  return {
    ...base,
    type: 'city',
    ...(['Jeju', 'Gyeongju', 'Piura', 'Cusco'].includes(en)
      ? { kind: 'tourist' as const }
      : {}),
    country,
    name: { ko, es, en },
    region,
